...
<head>
    ...
    <title>Cari Informasi Pajak</title>
                        ...
                        <div class="card" style="border-radius: 1rem; margin-top: 19px">
                            <div class="row g-0">
                                <div class="col-md-6 col-lg-5 d-none d-md-block">
                                    <img src="../img/logovertical.png" alt="login form" class="img-fluid" style="border-radius: 1rem 1rem;" />
                                 </div>
                                    <div class="col-md-6 col-lg-7 d-flex align-items-center">
                                        ...
                                        <h1 class="h2 text-gray-900 mb-4" style="margin-top: -4%;" >Website Masa Pajak</h1>
                                            ...
                                            <div class="form-outline mb-4">
                                                <input type="text"  name="nama" id="form2Example27" class="form-control form-control-lg" placeholder="Nama" required/>
